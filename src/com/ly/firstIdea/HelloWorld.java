...
public class HelloWorld { // yy2
    ...
    public HelloWorld(int age, String username) {
        this.age = age;
        this.username = username;
    }
...
//        so/*rtr*/
        ...
        System.out.println("HelloWorld.main");// ctrl + alt + down
